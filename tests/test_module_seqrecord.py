...
def test_stamp():
    ...
    a = SeqRecord("attt")
    assert a.stamp() == "slseguid-ot6JPLeAeMmfztW1736Kc6DAqlo"
    assert "pydna slseguid-ot6JPLeAeMmfztW1736Kc6DAqlo" in a.annotations["comment"]
    ...
    assert "pydna slseguid-ot6JPLeAeMmfztW1736Kc6DAqlo" in a.annotations["comment"]
    assert "pydna slseguid-sFjwltMUzuIRRD_zch5hCn_8RV8" in a.annotations["comment"]
