...
setup(  name            = 'pydna',
        ...
        setup_requires=['pytest-runner', "appdirs", "biopython", "prettytable",  "networkx", "ordered-set", "pyparsing"],
        tests_require=['pytest', "appdirs", "biopython", "prettytable",  "networkx", "ordered-set", "pyparsing"],
        install_requires = [ "appdirs", "biopython", "prettytable",  "networkx", "ordered-set", "pyparsing"],
        zip_safe = False,
